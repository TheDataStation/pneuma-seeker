...
- If a retrieved table has ID, or contains labels, categories, or values that match a user constraint or qualifier, you can take it into consideration (do not flat out disregard it).
